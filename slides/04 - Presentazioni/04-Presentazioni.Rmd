...
- `beamer_presentation`: <font size="3">per ottenere `pdf`. Le vedremo nella lezione [03bis-LaTeXbis](https://ottaviae.github.io/CorsoRmarkdown/slides/03bis%20-%20LaTeX%20Bis/03bis-LaTeX-bis.pdf)</font>
...
Aggiungete allo YAML: `runtime: shiny` <font size="3"> su una nuova riga </font> e vederete che `knit` viene sostituto da `Run Presentation`
