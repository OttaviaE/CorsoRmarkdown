...
<font size="3"> Se non viene modificato troppo il default, si può saltellare da html e pdf più volte!</font>
...
<span style="color:red">Parola colorata (PDF)</span>
...
Con `RMarkdown` base (quello che stiamo usando noi), non si può

`bookdown` invece ci permette di fare cross-references alle equazioni, alle figure (generate da codice) e alle tabelle: 
...
Nella breve lezione su [LaTeX](https://ottaviae.github.io/CorsoRmarkdown/slides/03%20-%20LaTeX/03-LaTeX.pdf) vedremo come usare al meglio e soprattutto in modo flessibile le cross-references 

## Cross-reference: La tabella
