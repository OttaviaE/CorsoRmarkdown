...
In figura \ref{fig:happyCat} si può vedere l'entusiasmo per il corso di RMarkdown.
	...
	\label{fig:happyCat}
	\centering
	\includegraphics[width=.50\linewidth]{C:/Users/huawei/OneDrive/Documenti/GitHub/CorsoRmarkdown/slides/03 - LaTeX/img/cat.jpg}
\end{figure}
\end{frame}
