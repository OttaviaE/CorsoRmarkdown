...
- Vi lascio comunque le slide per conoscenza generale
...
- Inserite una figura con cross-reference nel testo

- Inserite il plot del vostro data set con cross-reference nel testo (il codice è [\textcolor{blue}{qui}](https://ottaviae.github.io/CorsoRmarkdown/Datasets-Codici.html))

- Inserite una tabella con cross-reference nel testo

\begin{center}
ADAVANCED
\end{center}

- Inserite una figura con tre sottofigure (due foto e il grafico del vostro dataset) con rispettive cross-reference 

- Cambiate la pagina del titolo modificando il file [\textcolor{blue}{titolo.sty}](https://drive.google.com/file/d/1O4YgvAZnPJbNMOz0tugz5xf75TTxVvlY/view?usp=sharing)
